...
<head>
    ...
    <title>Admin Login - CourierXpress Logistics</title>
        ...
        <form class="space-y-5" action="{{ route('admin.login.post') }}" method="POST">
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="text" id="username" name="username" value="{{ old('username') }}" placeholder="e.g., ADMIN_HANOI_01" required autofocus
