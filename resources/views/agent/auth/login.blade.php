...
<head>
    ...
    <title>Agent Login - CourierXpress Logistics</title>
    ...
    <div class="p-8 sm:p-10">
        <div class="flex flex-col items-center text-center mb-8">
            ...
            <div class="mt-6 w-full">
                <h2 class="text-lg font-semibold text-gray-800">Agent Portal</h2>
                <p class="text-sm text-gray-500 mt-1">Sign in to access your workspace</p>
            </div>
        </div>
        ...
        <form class="space-y-5" action="{{ route('agent.login.post') }}" method="POST">
            ...
            <div>
                <label for="username" class="block text-sm font-semibold text-gray-700 mb-1.5">Agent ID / Username</label>
                <div class="relative">
                    <div class="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
                        <i data-lucide="user" class="w-4 h-4 text-gray-400"></i>
                    </div>
                    <input type="text" id="username" name="username" value="{{ old('username') }}" placeholder="e.g., AGENT_HANOI_01" required autofocus
            ...
            <div class="flex items-center justify-between pt-1">
                ...
                <a href="#" class="text-sm font-semibold text-primary-600 hover:text-primary-800 transition-colors">Forgot password?</a>
            </div>
