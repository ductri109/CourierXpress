...
@section('title', 'Track Waybill - CourierXpress')
        ...
        <div class="max-w-4xl mx-auto px-4">
            ...
            <div class="bg-white rounded-3xl shadow-xl overflow-hidden border border-gray-100 mb-8">
                <div class="gradient-bg p-10 text-white text-center">
                    ...
                    <h2 class="text-3xl font-extrabold tracking-tight">Track Your Shipment Journey</h2>
                    <p class="text-white/80 mt-2 font-medium">Enter your tracking ID to check the delivery status</p>
                </div>
                ...
                <div class="p-8 md:p-12">
                    ...
                    <form action="{{ route('tracking') }}" method="GET" class="flex flex-col sm:flex-row gap-4">
                        <div class="relative flex-1">
                            ...
                            <input type="text" name="tracking_id" value="{{ $tracking_id ?? '' }}" placeholder="e.g., CX-1A2B3C..." required
            ...
            @if(isset($order))
                <div class="bg-white rounded-3xl shadow-xl overflow-hidden border border-gray-100 p-8 md:p-12">
                    <div class="flex flex-col md:flex-row justify-between items-start md:items-center border-b border-gray-100 pb-6 mb-6">
                        <div>
                            <p class="text-sm text-gray-500 font-medium">Tracking ID</p>
                    ...
                    <div class="grid md:grid-cols-2 gap-8 mb-8">
                        <div class="bg-gray-50 p-6 rounded-2xl border border-gray-100">
                            <div class="flex items-center space-x-2 mb-4">
                                ...
                                <h4 class="font-bold text-gray-900">Sender Information</h4>
                            </div>
                        ...
                        <div class="bg-gray-50 p-6 rounded-2xl border border-gray-100">
                            <div class="flex items-center space-x-2 mb-4">
                                ...
                                <h4 class="font-bold text-gray-900">Receiver Information</h4>
                            </div>
                    ...
                    <div class="bg-blue-50 border border-blue-100 rounded-xl p-4 flex items-start space-x-3">
                        ...
                        <p class="text-sm text-blue-800">
                            To protect customer privacy, detailed phone numbers have been hidden. Please contact our hotline at 1900 6868 if you require further assistance regarding this shipment.
                        </p>
                    </div>
                </div>
            @endif
