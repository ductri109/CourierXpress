...
@section('title', 'Personal Profile - CourierXpress')
    ...
    <div class="pt-24 pb-20 bg-gray-50 min-h-screen">
        <div class="max-w-4xl mx-auto px-4">
            ...
            <div class="flex items-center space-x-2 text-sm text-gray-500 mb-6 ml-2">
                ...
                <span class="text-primary-600 font-medium">My profile</span>
            </div>
                ...
                <div class="gradient-bg p-10 text-white relative overflow-hidden">
                    <div class="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
                        <div class="flex items-center space-x-6">
                            ...
                            <div class="text-left">
                                <h2 class="text-3xl font-extrabold tracking-tight">Personal Profile</h2>
                            </div>
                        </div>
                    ...
                    <div class="space-y-12">
                        ...
                        <div class="relative">
                            <div class="flex items-center space-x-3 mb-8">
                                ...
                                <h3 class="text-xl font-bold text-gray-900">Identity Information</h3>
                        ...
                        <div class="relative">
                            <div class="flex items-center space-x-3 mb-8">
                                ...
                                <h3 class="text-xl font-bold text-gray-900">Contact & Address</h3>
                                <div class="flex-1 h-px bg-gray-100 ml-2"></div>
                            </div>
                            ...
                            <div class="grid md:grid-cols-3 gap-10 ml-2 bg-gray-50/50 p-6 rounded-3xl border border-dashed border-gray-200">
                                <div class="space-y-1">
                                    ...
                                    <div class="flex items-center space-x-2">
                                        ...
                                        <p class="text-lg font-bold text-gray-800">{{ Auth::guard('customer')->user()->phone ?? 'Not updated' }}</p>
                                    </div>
                                </div>

                                <div class="md:col-span-2 space-y-1">
                                    <label class="text-xs font-bold text-gray-400 uppercase tracking-widest">Default Address</label>
                                    <p class="text-lg font-medium text-gray-700 leading-relaxed">
                                        {{ Auth::guard('customer')->user()->address ?? 'Please add your delivery address...' }}
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="pt-8 border-t border-gray-100 flex flex-col items-center">
                            ...
                            <p class="mt-4 text-gray-400 text-sm flex items-center">
                                ...
                                Need to change your information? Click the button above.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="mt-8 p-6 bg-white rounded-2xl flex items-center justify-between border border-gray-100 shadow-sm">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <p class="text-sm font-bold text-gray-900">Protected Data</p>
                        <p class="text-xs text-gray-500">CourierXpress uses end-to-end encryption for your personal information.</p>
                    </div>
                </div>
